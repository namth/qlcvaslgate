                        ...
                        <div class="inner">
                            <div class="author-profile">
                                <div class="image">
                                    ...
                                    <button class="edit"><i class="zmdi zmdi-cloud-upload"></i>Đổi hình</button>
                                </div>
                            ...
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="order-details-customer-info">
                                        <ul class="mb-30">
                                            <li>
                                                <span><i class="ti-email"></i> Công ty</span>
                                            ...
                                            <li>
                                                <span><i class="ti-mobile"></i> Số điện thoại</span>
                                        ...
                                        <a href="<?php echo get_bloginfo('url'); ?>/sua-thong-tin-khach-hang/?uid=<?php echo get_the_ID(); ?>" class="button button-primary"><span><i class="fa fa-edit"></i>Chỉnh sửa</span></a>
                                    </div>
                                </div>
