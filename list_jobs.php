                                ...
                                if ($query->have_posts()) {
                                    while ($query->have_posts()) {
                                        ...
                                        echo "<td class='action_cell'>
                                                ...
                                                <!-- a class='hidden_link' href='" . get_bloginfo('url') . "/duplicate-job/?jobid=" . get_the_ID() . "'  onclick=\"return confirm('" . __('Bạn có chắc muốn nhân đôi việc này?', 'qlcv') . "')\"><i class='fa fa-clone'></i> " . __('Duplicate This', 'qlcv') . "</!-->
                                            </td>";
