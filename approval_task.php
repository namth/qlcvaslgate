...
if ($id_email) {
    ...
    if ($email_post) {
        $replace_arr = array(
            ...
            '{partner_tax_number}'      => get_field('mst', 'user_' . $partner['ID']),
            '{partner_legal_representative}' => get_field('nguoi_dai_dien_phap_luat', 'user_' . $partner['ID']),
            '{partner_position}'        => get_field('chuc_vu', 'user_' . $partner['ID']),
            '{our_ref}'                 => $our_ref,
